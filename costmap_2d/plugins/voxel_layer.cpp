                                           ...
                                           double* max_x, double* max_y)
{
  ...
  updateUpdateCells(updatedColumns, updated_area_width, (int)sensor_x - update_area_center, (int)sensor_y - update_area_center);
...
void VoxelLayer::updateUpdateCells(boost::shared_ptr<bool[]> updated_columns, unsigned int updated_area_width, unsigned int offset_x, unsigned int offset_y)
{
